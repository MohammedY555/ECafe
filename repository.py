...
def add_menu(db, title, title_id, description, description_id, status, status_time, price):
    try:
        menu = Menu(title=title, title_id=title_id, description=description, description_id=description_id, status=status, status_time=status_time,
                    price=price)
        db.add(menu)
        db.commit()
